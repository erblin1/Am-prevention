...
const QNA = () => {
  ...
  const [userMessages, setUserMessages] = useState(_user.messages);
  ...
  // _user.messages.map((message) => console.log(message));
  return (
    <>
      <SideNav />
